...
class Review:
    ...
    def employee_id(self, value):
        from employee import Employee  # Assuming you have an Employee class defined
        employee = Employee.find_by_id(value)
        if not employee:
            raise ValueError("Employee with the specified id does not exist")
